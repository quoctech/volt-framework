...
use App\Modules\Hrms\Entities\Employeeeducation\Employeeeducation;
use Volt\Core\Models\VoltModel;

final class EmployeeeducationModel extends VoltModel
{
    protected $table = 'tab_employeeeducation';
    ...
    private ?Employeeeducation $docType = null;

    public function __construct()
    {
        parent::__construct();
        $this->setEntityName('Employeeeducation');
    }
    ...
    private function docType(): Employeeeducation
    {
        return $this->docType ??= new Employeeeducation();
    }
