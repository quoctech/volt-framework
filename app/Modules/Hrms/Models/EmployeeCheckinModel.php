...
use App\Modules\Hrms\Entities\EmployeeCheckin\EmployeeCheckin;
use Volt\Core\Models\VoltModel;

final class EmployeeCheckinModel extends VoltModel
{
    protected $table = 'tab_employee_checkin';
    ...
    private ?EmployeeCheckin $docType = null;

    public function __construct()
    {
        parent::__construct();
        $this->setEntityName('EmployeeCheckin');
    }
    ...
    private function docType(): EmployeeCheckin
    {
        return $this->docType ??= new EmployeeCheckin();
    }
