...
<body class="min-h-screen bg-zinc-100 text-base text-zinc-900">
    <div x-data="employee_skill_mapFormApp({
        ...
        <header class="mb-4 flex items-center justify-between border border-zinc-300 bg-white px-4 py-3">
            <div>
                ...
                <p class="text-zinc-500"><?= esc('/hrms/employee_skill_map') ?></p>
            </div>
    ...
    <script><?php readfile(APPPATH . 'Modules/Hrms/Entities/EmployeeSkillMap/employee_skill_map_form.js'); ?></script>
</body>
</html>