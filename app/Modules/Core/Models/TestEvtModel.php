...
use App\Modules\Core\Entities\TestEvt\TestEvt;
use Volt\Core\Models\VoltModel;

final class TestEvtModel extends VoltModel
{
    ...
    private ?TestEvt $docType = null;

    public function __construct()
    {
        parent::__construct();
        $this->setEntityName('TestEvt');
    }
    ...
    private function docType(): TestEvt
    {
        return $this->docType ??= new TestEvt();
    }
