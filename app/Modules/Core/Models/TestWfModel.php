...
use App\Modules\Core\Entities\TestWf\TestWf;
use Volt\Core\Models\VoltModel;

final class TestWfModel extends VoltModel
{
    ...
    private ?TestWf $docType = null;

    public function __construct()
    {
        parent::__construct();
        $this->setEntityName('TestWf');
    }
    ...
    private function docType(): TestWf
    {
        return $this->docType ??= new TestWf();
    }
