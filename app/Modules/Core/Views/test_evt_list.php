...
<body class="min-h-screen bg-zinc-100 text-base text-zinc-900">
    <div x-data="test_evtListApp({
            ...
            deleteUrlBase: <?= esc(json_encode(site_url('core/api/test_evt/delete'), JSON_UNESCAPED_UNICODE | JSON_UNESCAPED_SLASHES), 'attr') ?>,
            ...
            submitUrlBase: <?= esc(json_encode(site_url('core/api/test_evt/submit'), JSON_UNESCAPED_UNICODE | JSON_UNESCAPED_SLASHES), 'attr') ?>,
            approveUrlBase: <?= esc(json_encode(site_url('core/api/test_evt/approve'), JSON_UNESCAPED_UNICODE | JSON_UNESCAPED_SLASHES), 'attr') ?>,
            cancelUrlBase: <?= esc(json_encode(site_url('core/api/test_evt/cancel'), JSON_UNESCAPED_UNICODE | JSON_UNESCAPED_SLASHES), 'attr') ?>,
            amendUrlBase: <?= esc(json_encode(site_url('core/api/test_evt/amend'), JSON_UNESCAPED_UNICODE | JSON_UNESCAPED_SLASHES), 'attr') ?>
        ...
        <header class="mb-4 flex items-center justify-between border border-zinc-300 bg-white px-4 py-3">
            <div>
                ...
                <p class="text-zinc-500">Generated list route: <?= esc('/core/test_evt') ?></p>
            </div>
            <div class="flex gap-2">
                <a href="<?= esc($builderUrl) ?>" class="border border-zinc-300 px-3 py-2 hover:bg-zinc-50">Open Builder</a>
                <a href="<?= esc($createUrl) ?>" class="inline-flex items-center border border-slate-900 bg-slate-900 px-3 py-2 font-semibold text-white hover:bg-slate-800">Create TestEvt</a>
            </div>
        </header>
    ...
    <script><?php readfile(APPPATH . 'Modules/Core/Entities/TestEvt/test_evt_list.js'); ?></script>
</body>
</html>