...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .code { font-size: 4rem; font-weight: 700; color: #f59e0b; line-height: 1; margin-bottom: .5rem; }
        h1 { font-size: 1.25rem; font-weight: 600; margin-bottom: .75rem; }
        p { color: #71717a; font-size: .875rem; line-height: 1.5; }
        .detail { margin-top: 1rem; padding: .75rem; background: #fefce8; border-radius: 8px; font-size: .8125rem; color: #92400e; word-break: break-word; }
...
<body>
    <div class="card">
        ...
        <h1>Bad Request</h1>
        <p>The request could not be processed due to invalid syntax or parameters.</p>
